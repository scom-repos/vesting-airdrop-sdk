...
exports.doClaimAll = exports.doClaim = exports.getMyClaims = exports.getUnverifiedLockInfoMap = exports.getUnverifiedLockInfo = exports.doVerifyMerkleLock = void 0;
const eth_wallet_1 = require("@ijstech/eth-wallet");
const common_1 = require("./common");
const contracts_1 = require("../contracts");
async function doVerifyMerkleLock(wallet, contractAddress, lockId, vestingData) {
    const vesting = new contracts_1.ScomAirdropVault(wallet, contractAddress);

...
exports.ScomVestingVault = void 0;
const eth_wallet_1 = require("@ijstech/eth-wallet");
const ScomVestingVault_json_1 = __importDefault(require("./ScomVestingVault.json"));
class ScomVestingVault extends eth_wallet_1.Contract {
    constructor(wallet, address) {
        super(wallet, address, ScomVestingVault_json_1.default.abi, ScomVestingVault_json_1.default.bytecode);
        this.assign();
    }
    deploy(params) {
    ...
    assign() {
        ...
        let newLockParams = (params) => [eth_wallet_1.Utils.toString(params.campaignId), params.recipient, eth_wallet_1.Utils.toString(params.amount), eth_wallet_1.Utils.toString(params.startDate), eth_wallet_1.Utils.toString(params.endDate)];
...
exports.ScomVestingVault = ScomVestingVault;

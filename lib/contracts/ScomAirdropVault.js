...
exports.ScomAirdropVault = void 0;
const eth_wallet_1 = require("@ijstech/eth-wallet");
const ScomAirdropVault_json_1 = __importDefault(require("./ScomAirdropVault.json"));
class ScomAirdropVault extends eth_wallet_1.Contract {
    constructor(wallet, address) {
        super(wallet, address, ScomAirdropVault_json_1.default.abi, ScomAirdropVault_json_1.default.bytecode);
        this.assign();
    }
    deploy(params) {
...
exports.ScomAirdropVault = ScomAirdropVault;
